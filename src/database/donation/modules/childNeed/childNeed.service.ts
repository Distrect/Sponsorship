import { INeedWithTotal } from '../../entities/childNeed/childNeed.dao';
...
import {
  ...
  EditNeed,
  EditNeedDTO,
} from 'src/database/donation/modules/childNeed/childNeed.dto';
import {
  IsNotActiveGroup,
  ServerError,
  UserNotFoundError,
...
export default class ChildNeedService {
  private childRepository: ChildEntityService;
